...
- You have Four IP addresses available for static assignment -OR- the ability to configure DHCP reservations within the VM's destined subnet. The three are for the VM's themselves, the fourth is used by kube-vip to loadbalance traffic in our cluster.
